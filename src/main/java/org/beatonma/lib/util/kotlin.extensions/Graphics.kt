...
/* Rect */
fun Rect.update(left: Int = this.left, top: Int = this.top,
                right: Int = this.right, bottom: Int = this.bottom) {
    set(left, top, right, bottom)
}

fun Rect.updateBy(left: Int = 0, top: Int = 0,
...
/* RectF */
fun RectF.update(left: Float = this.left, top: Float = this.top,
                 right: Float = this.right, bottom: Float = this.bottom) {
    set(left, top, right, bottom)
}

fun RectF.updateBy(left: Float = 0F, top: Float = 0F,
